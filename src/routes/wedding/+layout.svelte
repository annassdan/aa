...
<div class="w-full h-full relative text-md font-catamaran">
    <slot></slot>
    <div in:slide={{delay: 400, duration: 400}} class="fixed flex flex-col items-center bottom-3 z-50 w-full px-3">
